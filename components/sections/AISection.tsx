    ...
    <section className="bg-starlight py-24 lg:py-32">
      <Container>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <AnimateIn>
            <SectionHeading title="When repetitive work starts slowing the business down" align="left" />
            <div className="mt-8 space-y-6 text-text-secondary text-lg">
              <p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-8 lg:mt-0">
            {examples.map((example, i) => (
              <AnimateIn key={example.label} delay={i * 50}>
                <div className="bg-white border border-border-subtle p-5 rounded-lg shadow-sm flex flex-col items-center text-center gap-3 h-full">
                  <div className="w-10 h-10 rounded-full bg-starlight flex items-center justify-center text-accent">
                    {example.icon}
                  </div>
