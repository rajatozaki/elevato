    ...
    <section className="py-24 lg:py-32 relative border-t border-border-subtle dark:border-border-subtle">
      <Container>
        ...
        <div className="max-w-2xl mx-auto mt-6 text-center">
          <AnimateIn delay={100}>
            <p className="text-lg text-text-secondary dark:text-text-muted-dark leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-14 max-w-4xl mx-auto">
          <AnimateIn delay={200}>
            <div className="bg-surface/90 dark:bg-surface/90 border border-border-subtle dark:border-border-subtle p-8 rounded-2xl shadow-xs flex flex-col items-center text-center transition-all duration-300 hover:border-accent/40 dark:hover:border-accent/40">
              <div className="w-20 h-20 bg-starlight dark:bg-surface-elevated border border-border-subtle dark:border-border-subtle rounded-full flex items-center justify-center text-2xl font-bold font-mono text-text-primary dark:text-text-on-dark mb-6">
                Y
              </div>
              <h3 className="text-xl font-bold text-text-primary dark:text-text-on-dark">Yash</h3>
              <p className="text-accent-dark dark:text-accent font-medium text-xs font-mono uppercase tracking-wider mb-4">Founder</p>
              <p className="text-text-secondary dark:text-text-muted-dark text-sm leading-relaxed">
          ...
          <AnimateIn delay={300}>
            <div className="bg-surface/90 dark:bg-surface/90 border border-border-subtle dark:border-border-subtle p-8 rounded-2xl shadow-xs flex flex-col items-center text-center transition-all duration-300 hover:border-accent/40 dark:hover:border-accent/40">
              ...
              <h3 className="text-xl font-bold text-text-primary dark:text-text-on-dark">Rajat</h3>
        ...
        <AnimateIn delay={400} className="mt-8 text-center max-w-2xl mx-auto">
          <p className="text-xs text-text-tertiary dark:text-text-muted-dark font-mono">
